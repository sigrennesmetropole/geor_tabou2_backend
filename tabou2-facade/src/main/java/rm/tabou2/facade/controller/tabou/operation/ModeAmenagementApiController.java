...
public class ModeAmenagementApiController implements ModeAmenagementApi {
    ...
    @Override
    public ResponseEntity<PageResult> getModesAmenagement(@Valid Integer start, @Valid Integer resultsNumber, @Valid String orderBy, @Valid Boolean asc) throws Exception {
