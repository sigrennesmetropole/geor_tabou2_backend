...
public class OperationV1ApiController extends AbstractExportDocumentApi implements OperationsApi {
    ...
    private final OperationV1Mapper mapper;
    ...
    @Override
    public ResponseEntity<OperationV1> getOperationByIdV1(Long operationId) {
    ...
    public ResponseEntity<PageResult> searchOperations(String nom, String nature, String vocation, String decision,
            ...
            String tiers, Integer start, Integer resultsNumber, String orderBy, Boolean asc) {
        ...
        Page<OperationV1> page = mapper.entitiesToDto(operationService.searchOperations(operationsCriteria, pageable),
                pageable);
