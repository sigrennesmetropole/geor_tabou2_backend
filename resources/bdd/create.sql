...
create table tabou_operation (
                           ...
                           hebergement_resid_senior_prevu integer,
                           hebergement_resid_senior_realise integer,
                           ql1 varchar(255),
                           scot boolean,
...
create table tabou_programme (
                           ...
                           prix_logts_libres_m2_shab_prevu double precision,
                           prix_logts_libres_m2_shab_realise double precision,
                           prix_terrain_batir_m2_prevu double precision,
                           prix_terrain_batir_m2_realise double precision,
