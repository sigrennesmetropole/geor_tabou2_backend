package rm.tabou2.storage.tabou.dao.constants;
...
public class FieldsConstants {
    ...
    public static final String FIELD_ANNULATION_DATE = "dateAnnulation";
    ...
    public static final String FIELD_ID_TYPE_PLH_PARENT = "id_type_plh_parent";
}
